...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Tambah Data Siswa</h1>
    </div>
...
unset($__errorArgs, $__bag); ?>' type='text' name='name' id='name' placeholder='Masukkan Nama' value='<?php echo e(old('name')); ?>' />
...
unset($__errorArgs, $__bag); ?>' type='email' name='email' id='email' placeholder='Masukkan Email' value='<?php echo e(old('email')); ?>' />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projekattend\resources\views/pages/admin/siswa/create.blade.php ENDPATH**/ ?>